...
public class AddDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SecAdapter=new ArrayAdapter<>(this,android.R.layout.simple_spinner_item,this.getResources().getStringArray(R.array.Group_Choice));
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(name.getText().toString().equals("")&&dataSnapshot.exists()){
                            ...
                            section.setSelection(Arrays.asList(AddDetails.this.getResources()
                                    .getStringArray(R.array.Group_Choice)).indexOf(user.sect));
